...
import Tab1 from './rencontreContact';
import Tab2 from './demandeRencontre';
...
<Container>
     ...
     <Tabs style= {{backgroundColor:"#ffcccc"}} >
          <Tab heading={ <TabHeading><Icon name="bookmarks" /><Text>Mes contacts</Text></TabHeading>}  >
            <Tab1 param1={this.props.param1}/>
          </Tab>
          <Tab heading={ <TabHeading><Text>Intéreser à moi</Text></TabHeading>}>
