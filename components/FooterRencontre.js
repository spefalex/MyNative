...
getRenconc(idUtisateur) {

Actions.rencontreSave({param1:idUtisateur});

} 

RencontreSauvegarde (idUtisateur) {
  ...
  render() {
    return (
        ...
        <Footer>
          <FooterTab>
            <Button vertical>
              <MyIcon name='sliders' size = {25}  color="#5dade2" onPress={this.filtreRencontre} />
        
            </Button>

             
             <Button vertical>
              <MyIcon name='check-circle-o' size = {25}  color="#5dade2" onPress={this.RencontreSauvegarde.bind(this,this.props.id)}/>
            ...
            <Button >
              <MyIcon name="star-o" size = {25} color="#28b463" onPress={this.RencontreSauvegarde.bind(this,this.props.id)} />
