...
//alert(id)
 return fetch('http://192.168.0.96:1337/LireEmploie/Matcher?idUtilisateurs='+id)
...
<CardItem>
  ...
  <List style={{flexDirection:'column', flexWrap: 'wrap', alignItems: 'flex-start' ,flexDirection:'row'}} >
            ...
            <ListItem itemHeader>
    <Text style={{fontSize:16,color:"#ff6666", alignSelf:'center'}} onPress={function(){ this.ignorer(emploisData.id,index) }.bind(this) } > <MyIcon name="close" size = {16} color="#ff6666" /> Supprimer </Text>
            </ListItem>
